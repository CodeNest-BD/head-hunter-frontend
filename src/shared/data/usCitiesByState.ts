...
// Source: US Census Bureau 2023 Gazetteer Places file (public domain):
// https://www2.census.gov/geo/docs/maps-data/data/gazetteer/2023_Gazetteer/
// Every populated place (incorporated municipalities + census-designated
// places) per state, keyed by USPS code. Designation suffixes are stripped.
